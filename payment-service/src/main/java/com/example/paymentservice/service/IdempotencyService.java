...
public class IdempotencyService {
    ...
    public boolean isAlreadyProcessed(String eventKey) {
        com.example.paymentservice.entity.SagaProcessedEvent existing = 
            entityManager.find(com.example.paymentservice.entity.SagaProcessedEvent.class, eventKey);

        if (existing != null) {
            return true;
        }

        com.example.paymentservice.entity.SagaProcessedEvent newEvent = 
            new com.example.paymentservice.entity.SagaProcessedEvent(eventKey);
