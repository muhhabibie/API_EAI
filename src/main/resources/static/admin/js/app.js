...
async function initAdmin(silent = false) {
    ...
    try {
        ...
        const [customers, products, orders, categories, shipments, reservations] = await Promise.all([
        ...
        AdminUI.showNotification("Gagal menghubungi server Backend EAI.", "bg-red-600");
    }
}
